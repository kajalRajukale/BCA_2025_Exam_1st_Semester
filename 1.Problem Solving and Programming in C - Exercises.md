...
### Exercise: Find the Sum of Positive Numbers

#### Description: Write a program that calculates the sum of all positive numbers in an array.

#### Hint: Use a loop to iterate through the array and add the positive numbers to the sum.
...
### Exercise: Find the Sum of Negative Numbers

#### Description: Write a program that calculates the sum of all negative numbers in an array.

#### Hint: Use a loop to iterate through the array and add the negative numbers to the sum.
...
### Exercise: Find the Product of Array Elements

#### Description: Write a program that calculates the product of all elements in an array.

#### Hint: Use a loop to iterate through the array and multiply each element to the product.
...
### Exercise: Find the Smallest Element in Array

#### Description: Write a program that finds the smallest element in an array.

#### Hint: Use a loop to iterate through the array and compare each element to find the smallest.
...
### Exercise: Find the Second Smallest Element in Array

#### Description: Write a program that finds the second smallest element in an array.

#### Hint: Use a loop to iterate through the array and keep track of the smallest and second smallest elements.
...
### Exercise: Find the Sum of Prime Numbers

#### Description: Write a program that calculates the sum of all prime numbers between 1 and a given number.
